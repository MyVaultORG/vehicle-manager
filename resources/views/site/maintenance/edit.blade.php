...
<form action="{{ Route('user.maintenance.update', $maintenance->id) }}" method="post" id="form-ajax">
    @csrf
    @method("PUT")
    ...
    <div class="form-group">
        ...
        <input type="date" min="{{ date('Y/m/d') }}" value="{{ $maintenance->date }}" id="date" name="date" class="form-control">        
    </div>    
